...
const about_me: string = "I am a university undergraduate final year student with Computer Science major. " +
    "Basically, I'm a Full Stack Web Programmer, writes robust and large scaled web applications with React & Django. " +
...
export function AboutMe() {
    ...
    return (
        <div
            id='aboutme'
            style={main_style}
            className='mt-1 p-5 text-bg-light d-flex flex-column'
        >
            ...
            <div className="d-flex justify-content-around align-items-center">
                ...
                <p
                    style={amd_styles}
                    className="d-flex flex-wrap px-4 py-2 bg-info bg-opacity-10 border border-info border-start-0 rounded-end"
                >
                    {about_me}
                </p>
            </div>
